                                ...
                                <div className="overflow-hidden">
                                    <table className="min-w-full">
                                        ...
                                        <thead className="border-b border-NewGray-19">
                                            <tr>
                                                <th scope="col" className="text-center laptop:pl-14 pl-7 desktop:text-3xl laptop:text-2xl text-xl font-bold text-warm-gray-400">
                                                    Compare plans
                                                </th>
                                ...
                                <div className="overflow-hidden">
                                    <table className="min-w-full">
                                        ...
                                        <tbody>
                                            ...
                                            <tr className="border-b border-NewGray-19">
                                                <td className="laptop:pl-14 pl-7 laptop:text-base text-sm font-medium text-warm-gray-400">In-video checkout</td>
                                                <td className="laptop:text-base text-sm text-warm-gray-700 font-medium text-center">
                                                    <i className="laptop:text-2xl text-xl text-black ri-check-line"></i>
                                                </td>
                                                <td className="laptop:text-base text-sm text-warm-gray-700 font-medium text-center">
                                            ...
                                            <tr className="border-b border-NewGray-19">
                                                <td className="laptop:pl-14 pl-7 laptop:text-base text-sm font-medium text-warm-gray-400">Advanced Customizations & workflows based on SOW</td>
                                                <td className="laptop:text-base text-sm text-warm-gray-700 font-medium text-center">
                                                    -
                                                </td>
                                                <td className="laptop:text-base text-sm text-warm-gray-700 font-medium text-center">
                            ...
                            <div className="py-2 inline-block min-w-full sm:px-6 lg:px-8">
                                <div className="overflow-hidden">
                                    <table className="min-w-full">
                                        ...
                                        <tbody>
                                            <tr className="border-b border-NewGray-19">
                                                <td className="laptop:pl-14 pl-7 laptop:text-base text-sm font-medium  text-warm-gray-400">Shopify / WooCommerce </td>
                                                <td className="laptop:text-base text-sm text-warm-gray-700 font-medium text-center">
                                                    <i className="laptop:text-2xl text-xl text-black ri-check-line"></i>
                                                </td>
                                                <td className="laptop:text-base text-sm text-warm-gray-700 font-medium text-center">
